...
import ImageViewer, { ZoomableImage } from '../components/ImageViewer'
...
function VisualizationModal({ viz, onClose }) {
  ...
  return (
    <>
                ...
                >
                  <ZoomableImage
                    ...
                    onError={(e) => {
                      ...
                      p.style.cssText = 'display:flex;align-items:center;justify-content:center;width:100%;height:100%;color:rgba(255,255,255,0.2);font-size:13px;font-family:Inter,sans-serif;letter-spacing:0.08em;text-transform:uppercase;'
      ...
      {/* Full-screen image viewer — rendered above everything */}
      {viewerOpen && (
        <ImageViewer
          images={viz.screenshots}
