  ...
  return (
    <div className="split">
      ...
      <div className="hero-content">
        ...
        <p className="h-sub">
          CFD engineer specializing in OpenFOAM and advanced visualization. 
          I create reproducible simulation pipelines and build intuitive web interfaces 
          that transform complex data into actionable insights for engineers and stakeholders.
        </p>
